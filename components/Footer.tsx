  ...
  return (
    <footer className="relative w-full min-h-screen flex flex-col justify-between bg-stone-900 overflow-hidden text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 mb-24 border-t border-white/10 pt-16">
          ...
          <div className="md:col-span-4">
            ...
            <ul className="space-y-4 text-stone-400 font-light text-sm">
              <li>
                <a href="#" onClick={(e) => handleNavClick('home', e)} className="hover:text-white transition-colors duration-300 block hover:translate-x-1">
                  Home
                </a>
              </li>
              <li>
                <a href="#" onClick={(e) => handleNavClick('itinerary', e)} className="hover:text-white transition-colors duration-300 block hover:translate-x-1">
                  Itinerary
                </a>
              </li>
              <li>
                <a href="#" onClick={(e) => handleNavClick('about', e)} className="hover:text-white transition-colors duration-300 block hover:translate-x-1">
                  About Us
                </a>
              </li>
              <li>
                <a href="#" onClick={(e) => handleNavClick('contact', e)} className="hover:text-white transition-colors duration-300 block hover:translate-x-1">
                  Contact Us
                </a>
              </li>
            </ul>
          ...
          <div className="md:col-span-3">
            ...
            <ul className="space-y-4 text-stone-400 font-light text-sm">
              <li>
                <a href="mailto:hello@rootsandroutes.com" className="hover:text-white transition-colors border-b border-stone-700 hover:border-white pb-1">
                  hello@rootsandroutes.com
                </a>
              </li>
              <li>(+39) 091-XXX-X422</li>
              <li className="leading-6">
                138 Vittorio Emanuele, 12,<br />
      ...
      <div className="relative z-10 w-full overflow-hidden flex flex-col items-center justify-end">
        {/* Huge Text - Scaled to fill full width */}
        <motion.h1
          ref={brandRef}

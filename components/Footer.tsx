            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 mb-24 border-t border-white/10 pt-16">
                ...
                <div className="md:col-span-3">
                    ...
                    <ul className="space-y-4 text-stone-400 font-light text-sm">
                        ...
                        <li><a href="#" onClick={(e) => handleNavClick('itinerary', e)} className="hover:text-white transition-colors duration-300 block hover:translate-x-1">Itinerary</a></li>
                        <li><a href="#" onClick={(e) => handleNavClick('about', e)} className="hover:text-white transition-colors duration-300 block hover:translate-x-1">About Us</a></li>

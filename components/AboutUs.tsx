...
const AboutUs: React.FC = () => {
  ...
  const yPolaroidLeft = useTransform(scrollYProgress, [0, 1], [0, -150]);
  const yPolaroidRight = useTransform(scrollYProgress, [0, 1], [50, -50]);
  ...
  return (
    <section ref={containerRef} className="relative w-full py-32 md:py-48 bg-[#FDFBF7] overflow-hidden">
          ...
          <motion.div style={{ y: yText, opacity }}>
            ...
            <div className="flex flex-col items-center gap-8">
              <p className="text-lg md:text-xl text-stone-600 font-light leading-relaxed max-w-2xl mx-auto antialiased">
                It began with a single journey to the sun-drenched coasts of Sicily. Enchanted by the ancient landscapes and the warmth of its people, we realized this wasn't just a destination—it was a{' '}
                <strong className="font-medium text-stone-800">feeling</strong> we had to share with the world.
              </p>
              {/* Signature Block */}
      ...
      <motion.div style={{ y: yPolaroidLeft }} className="absolute top-0 left-0 w-full h-full pointer-events-none xl:pointer-events-auto">
        ...
        <Polaroid
          variant="classic"
          src="images/sicilian_market2.webp"
          alt="Authentic Pasta"
